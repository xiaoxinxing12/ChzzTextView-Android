...
public class CHZZColorPicker extends View {
    ...
    public CHZZColorPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public CHZZColorPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CHZZColorPicker(Context context) {
        super(context);
        init();
    }
